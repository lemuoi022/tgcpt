...
if (isset($_SESSION['ss_admin'])) {
	...
	if ($user[0]['lv'] == 1) {
		...
		if (isset($_POST['add-product'])) {
			...
			$link = 'assets/images/';
			$target_file = $link . $_POST['product_brand']."/" . basename($img_link['name']);
...
//------------------------------------------------------------------------------------------------------------
			...
			//Bước 1 : Tạo đường dẫn upload lên hệ thống
			$link = 'assets/images/'  ;
			$target_file1 = $link . $_POST['product_brand']."/" . basename($img_link2['name']);
			//bước 2 : kiểm tra điều kiện upload
			//2.1: kích thước
...
//------------------------------------------------------------------------------------------------------------------------------------
			...
			//Bước 1 : Tạo đường dẫn upload lên hệ thống
			$link = 'assets/images/';
			$target_file2 = $link . $_POST['product_brand']."/" . basename($img_link3['name']);
			//bước 2 : kiểm tra điều kiện upload
			//2.1: kích thước
