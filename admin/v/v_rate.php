                    ...
                    <tbody>
                        <?php foreach ($data_rate_not_done as $key => $value) { ?>
                            <tr style="margin-top: 50px; text-align:center;">
                                ...
                                <th class="text-danger">Chưa duyệt</th>
                                <td>
                                    <a href="?controller=handle_rate&method=browse&id=<?php echo $value['id'] ?>" class="btn btn-success" style="font-size: 15px;">Duyệt</a>
                                    <a href="?controller=handle_rate&method=del&id=<?php echo $value['id'] ?>" class="btn btn-danger" name="" style="font-size: 15px;">Xóa</a>
                                </td>
                            </tr>
                        <?php } ?>
                        <?php foreach ($data_rate_done as $key => $value) { ?>
                            <tr style="text-align: center;">
                                ...
                                <th><?php echo $value['rate'] ?></th>
                                <th><?php echo $value['creat_at'] ?></th>
                                <th class="text-success">Đã duyệt</th>
                                <td>
                                    <a href="?controller=handle_rate&method=del&id=<?php echo $value['id'] ?>" class="btn btn-danger" name="" style="font-size: 15px;">Xóa</a>
                                </td>
                            </tr>
