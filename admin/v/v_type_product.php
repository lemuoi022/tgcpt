        ...
        <div class="container-fluid">
            ...
            <div>
                ...
                <div>
                    ...
                    <button class="btn-primary" data-toggle="modal" data-target="#exampleModal">Thêm loại sản phẩm</button>
                    ...
                    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <form action="?controller=add_type" method="post" name="main-form">
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="catalog_id">
                                        </div>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <input type="submit" class="btn btn-primary" name="add-type" value="Save"></input>
                                    </div>
                                </form>
                ...
                <table class="table table-white">
                    ...
                    <tbody>
                        <?php foreach ($data_type as $key => $value) { ?>
                            <tr style="text-align: center;">
                                <th style="padding-top: 30px;"><?php echo $value['name'] ?></th>
                                <th style="padding-top: 20px;"><?php echo $value['catalog_id'] ?></th>
                                <td>
                                    <a href="?controller=handle_type&method=edit&catalog_id=<?php echo $value['catalog_id'] ?>" class="btn btn-success" style="font-size: 15px;">Sửa</a>
                                    <a href="?controller=handle_type&method=del&catalog_id=<?php echo $value['catalog_id'] ?>" class="btn btn-danger" name="" style="font-size: 15px;">Xóa</a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
