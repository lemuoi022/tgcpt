...
<!-- End of Topbar -->
        ...
        <div class="container-fluid">
            ...
            <form action="?controller=handle_type&method=edit&catalog_id=<?php echo $_GET['catalog_id'] ?>" method="post">
                <div class="modal-body">
                
                    <div class="form-group">
                        <label for="">Tên loại sản phẩm</label>
                        <input type="text" class="form-control" name="name" value="<?php echo $data_type[0]['name'] ?>">
                    </div>
                    <div class="row mt-1">
                        <?php
                        if (isset($error['name'])) { ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="catalog_id" value="<?php echo $data_type[0]['catalog_id'] ?>">
                    </div>
                    <div class="row mt-1">
                        <?php
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal"><a href="?controller=type" style="text-decoration:none; color:#fff;">Close</a></button>
                    <input type="submit" class="btn btn-primary" name="edit_type" value="Save changes"></input>
                </div>
            </form>
