...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <form action="?controller=handle_laptop&method=edit&id=<?php echo $_GET['id'] ?>" method="post">
                <div class="modal-body">



                    <div class="form-group">
                        <label for="">Tên laptop</label>
                        <input type="text" class="form-control" name="laptop_name" value="<?php echo $data_laptop[0]['laptop_name']; ?>">
                    </div>
                    <?php if (isset($error['laptop_name'])) {
                        echo $error['laptop_name'];
                    }
                    ?>

                    <div class="form-group">
                        <label for="">Hãng laptop</label>
                        <input type="text" class="form-control" name="product_brand" value="<?php echo $data_laptop[0]['product_brand']; ?>">
                    </div>
                    <?php if (isset($error['product_brand'])) {
                        echo $error['product_brand'];
                    }
                    ?>

                    <div class="form-group">
                        <label for="">Màn hình</label>
                        <input type="text" class="form-control" name="monitor" value="<?php echo $data_laptop[0]['monitor']; ?>">
                    </div>
                    <?php if (isset($error['monitor'])) {
                        echo $error['monitor'];
                    }
                    ?>
                    ...
                    <div class="form-group">
                        <label for="">CPU</label>
                        <input type="text" class="form-control" name="cpu" value="<?php echo $data_laptop[0]['cpu']; ?>">
                    </div>
                    ...
                    <div class="form-group">
                        <label for="">RAM</label>
                        <input type="text" class="form-control" name="ram" value="<?php echo $data_laptop[0]['ram']; ?>">
                    </div>
                    ...
                    <div class="form-group">
                        <label for="">VGA</label>
                        <input type="text" class="form-control" name="vga" value="<?php echo $data_laptop[0]['vga']; ?>">
                    </div>
                    ...
                    <div class="form-group">
                        <label for="">SSD</label>
                        <input type="text" class="form-control" name="ssd" value="<?php echo $data_laptop[0]['ssd']; ?>">
                    </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal"><a href="?controller=laptop_detail" style="text-decoration:none; color:#fff;">Close</a></button>
                    <input type="submit" class="btn btn-primary" name="edit_laptop" value="Save changes"></input>
                </div>
            </form>
