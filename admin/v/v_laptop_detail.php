    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div>
                ...
                <div>
                    <button class="btn-primary" data-toggle="modal" data-target="#exampleModal">Thêm chi tiết sản phẩm</button>
                    ...
                    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <form action="?controller=add_laptop" method="post" name="main-form" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <input type="submit" class="btn btn-primary" name="add-laptop" value="Save changes"></input>
                                    </div>
                                </form>
            ...
            <form action="">
                <table class="table table-white">
                    ...
                    <tbody>
                        <?php foreach ($laptop_detail as $key => $value) { ?>
                            <tr style="text-align: center;">
                                <th><?php echo $value['id'] ?></th>
                                <td><?php echo $value['laptop_name'] ?></td>
                                ...
                                <td>
                                    <a href="?controller=handle_laptop&method=edit&id=<?php echo $value['id'] ?>" class="btn btn-success" style="font-size: 15px;">Sửa</a><br><br>
                                    <a href="?controller=handle_laptop&method=del&id=<?php echo $value['id'] ?>" class="btn btn-danger" name="" style="font-size: 15px;">Xóa</a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
