                    ...
                    <tbody>
                        <?php foreach ($product_detail as $key => $value) { ?>
                            <tr style="text-align: center;">
                                ...
                                <td>
                                    <a href="?controller=handle_pc&method=edit&id=<?php echo $value['id'] ?>" class="btn btn-success" style="font-size: 15px;">Sửa</a>
                                    <a href="?controller=handle_pc&method=del&id=<?php echo $value['id'] ?>" class="btn btn-danger" name="" style="font-size: 15px;">Xóa</a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
