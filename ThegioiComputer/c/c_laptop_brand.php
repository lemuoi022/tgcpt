...
switch ($brand) {
    case 'acer':
        ...
        $data_product4 = $db->get('laptop_detail', array('id' => $data[4]['product_id']));
        $data_product5 = $db->get('laptop_detail', array('id' => $data[5]['product_id']));
        $data_product6 = $db->get('laptop_detail', array('id' => $data[6]['product_id']));
        $data_product7 = $db->get('laptop_detail', array('id' => $data[7]['product_id']));

        $data_price0 = $db->get('product', array('product_id' => $data[0]['product_id']));
        $data_price1 = $db->get('product', array('product_id' => $data[1]['product_id']));
        $data_price2 = $db->get('product', array('product_id' => $data[2]['product_id']));
        $data_price3 = $db->get('product', array('product_id' => $data[3]['product_id']));
        $data_price4 = $db->get('product', array('product_id' => $data[4]['product_id']));
        $data_price5 = $db->get('product', array('product_id' => $data[5]['product_id']));
        $data_price6 = $db->get('product', array('product_id' => $data[6]['product_id']));
        $data_price7 = $db->get('product', array('product_id' => $data[7]['product_id']));
