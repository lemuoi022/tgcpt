        ...
        <div id="layout-page" class="clearfix">
            <?php foreach ($data_client as $key => $value) { ?>
                ...
                <div id="customer_orders" class="col-xs-12">
                    <h1>Xin chào <?php echo $value['name'] ?>,</h1>
                ...
                <div class="col-xs-12" id="customer_sidebar">
                    ...
                    <p class="email ">Email:<?php echo $value['email'] ?></p>
                    <div class="address ">
                        <address>Địa chỉ:<?php echo $value['address'] ?></address> 
                        <p>Số điện thoại:<?php echo $value['phone'] ?></p>
                        <a id="view_address" href="#">Sửa thông tin</a>
                        <br>
                        <a id="view_address" href="?controller=order_profile">Xem đơn hàng</a>
                    <?php } ?>
                    </div>
                </div>
                <a class="logout" href="?controller=logout"><span class="fa fa-sign-out"></span>Thoát</a>
        </div>
