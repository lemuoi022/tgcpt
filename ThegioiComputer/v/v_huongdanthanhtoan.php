...
<body>
  ...
  <div>
      ...
      <div  class="container">
        <div >
        <button type="button" class="btn btn-primary" style="font-weight: bold;color: black ;font-size: 25px;">1-Thanh toán trực tiếp</button><br><br>
          ...
          <div >
        <button type="button" class="btn btn-primary" style="font-weight: bold;color: black ;font-size: 25px;">2-Thanh toán chuyển khoản</button><br><br>
