...
<body>
  ...
  <div class="container">
    <div> <img src="./assets/images/noithanh.png" width="100%;">
    </div><br><br><br><br>
    ...
    <div style="text-align: center;font-weight: bold;font-size: 30px; color:red"><img src="./assets/images/dinhvi.png" width="150px">CÁC KHU VỰC NGOẠI THÀNH </div><br><br>
    <div  style="border: 3px solid blue;width: 600px;margin-left: 280px;">
        <span  class="btn btn-danger" style="font-size:25px;font-weight: bold;width: 100%;">Ngoại thành</span><br><br>
        <span style="font-size: 20px;">•  Áp dụng cho các tỉnh - thành ngoài Hà Nội (phí ship tính theo quãng đường KM).</span><br>
         <span style="font-size: 20px;">• Thời gian cụ thể shop sẽ báo với khách hàng khi sản phẩm sắp tới.</span>
