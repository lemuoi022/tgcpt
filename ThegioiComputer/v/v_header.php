        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              ...
              } else echo "<a class='nav-link' href='?controller=profile'><i class='fas fa-user-alt'></i>{$_SESSION['ss_name']}</a>
               </li>";;
              ?>
            ...
            <li class="nav-item">
              ...
              } else echo '<a class="nav-link" href="?controller=logout"><i class="fas fa-sign-out-alt"></i>Đăng xuất</a></li>';
              ?>
            <li class="nav-item">
    ...
    <div class="container-fluid list menu row" style="margin:auto;">
      <ul class="hover">
        <li class="hoverli">
          ...
          <ul class="file_menu">
            <li><a href="?controller=product&catalog=laptop"><i class="fas fa-laptop"></i>&nbsp;Laptop</a>
              <ul class="sub laptop">
            ...
            <li><a href="?controller=product&catalog=pc"><i class="fas fa-hdd"></i>&nbsp;PC</a>
              <ul class="sub computer">
                <li><a href="?controller=pc&brand=acer">Cấu hình văn phòng</a></li>
                <li><a href="?controller=pc&brand=asus">Cấu hình tầm trung</a></li>
                <li><a href="?controller=pc&brand=msi">Cấu hình cao cấp</a></li>
                <li><a href="?controller=pc&brand=dell">Cấu hình siêu cao cấp</a></li>
                <li><a href="?controller=pc&brand=lenovo">Cấu hình tự build</a></li>
              </ul>
            </li>
      ...
      <div class="list "><a href="?controller=ttmd" class="a-list"><i class="fas fa-hand-holding-usd"></i>Thông tin mùa dịch</a>
