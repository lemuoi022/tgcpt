...
<article class="card-body mx-auto" style="max-width: 400px;">
	...
	<div class="form-group input-group">
        ...
        <input name="username" class="form-control" placeholder="Tên tài khoản" type="text" required autofocus>
        <p class="offset-md-4 "  style="color:red"><?php if(isset($error['username'])) echo $error['username']; ?></p>
    </div> <!-- form-group// -->
    <div class="form-group input-group">
		<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-user"></i> </span>
		 </div>
        <input name="name" class="form-control" placeholder="Họ và tên" type="text" required autofocus>
    </div>
    <div class="form-group input-group">
    	<div class="input-group-prepend">
        ...
        <p class="  offset-md-4 "  style="color:red"><?php if(isset($error['email'])) echo $error['email']; ?></p>
    </div> <!-- form-group// -->
    <div class="form-group input-group">
    	<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fas fa-map-marked-alt"></i> </span>
		 </div>
        <input name="address" class="form-control" placeholder="Địa chỉ" type="text" required autofocus>
    </div>
    <div class="form-group input-group">
    	<div class="input-group-prepend">
    	...
    	<input name="phone" class="form-control" placeholder="Số điện thoại" type="text" required autofocus>
    </div> <!-- form-group// -->
    <div class="form-group input-group">
        ...
        <p class="  offset-md-4 "  style="color:red"><?php if(isset($error['gender'])) echo $error['gender']; ?></p>
    </div> <!-- form-group end.// -->
    <div class="form-group input-group">
    	<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-lock"></i> </span>
		</div>
        <input class="form-control" placeholder="Mật khẩu" type="password" name="password1" required autofocus>
        <p class="  offset-md-4 "  style="color:red"><?php if(isset($error['password'])) echo $error['password']; ?></p>
    </div> <!-- form-group// -->
    <div class="form-group input-group">
    	<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-lock"></i> </span>
		</div>
        <input class="form-control" placeholder="Nhặp lại mật khẩu" type="password" name="password2" required autofocus>
        <p class="  offset-md-4 "  style="color:red"><?php if(isset($error['password'])) echo $error['password']; ?></p>
    </div> <!-- form-group// -->                                      
