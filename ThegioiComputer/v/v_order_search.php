                        ...
                        foreach ($order as $key => $value) { ?>
                            <tr style="text-align: center;padding-top:30px;">
                                ...
                                <?php if ($value['status'] == 0) {
                                    ...
                                    <a href='?controller=handle_order&set=cancel&id={$value['id']}'><button type='submit' class='btn btn-danger'>Hủy đơn</button></a>
                                    <a href='?controller=handle_order&set=detail&id={$value['id']}'><button type='submit' class='btn btn-success'>Chi tiết</button></a>
                                    </td>";
                                } elseif ($value['status'] == 1) {
                                    echo "<td class='text-success font-weight-bold'>Đã duyệt
                                    <a href='?controller=handle_order&set=detail&id={$value['id']}'><button type='submit' class='btn btn-success'>Chi tiết</button></a>
             </td>";
                                }
                                ?>
