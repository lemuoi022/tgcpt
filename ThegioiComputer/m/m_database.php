...
class database
{
	...
	public function sortASC($table, $condition = array(), $expression)
    {
        $sql = "SELECT * FROM $table";
        if (!empty($condition)) {
            $sql .= " WHERE";
    ...
    public function sortDESC($table, $condition = array(), $expression)
    {
        $sql = "SELECT * FROM $table";
        if (!empty($condition)) {
            $sql .= " WHERE";
